...
): Promise<ApiResponse<V1ClusterRole>> {
...
export async function createClusterRoleBindingRaw(
  ...
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<ApiResponse<V1ClusterRoleBinding>> {
  if (requestParameters.body === null || requestParameters.body === undefined) {
    throw new Error(
...
export async function createNamespacedRoleBindingRaw(
  ...
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<ApiResponse<V1RoleBinding>> {
  if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
    throw new Error(
...
export async function watchListClusterRole(
  ...
  callback: (event: KubeEvent<ItemType<V1ClusterRoleList>>) => void,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<void> {
  ...
  await requestStream<ItemType<V1ClusterRoleList>>(
    callback,
    {
      path: `/apis/rbac.authorization.k8s.io/v1/clusterroles`,
      method: 'GET',
...
export async function listClusterRoleRaw(
  requestParameters: ListClusterRoleRequest,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<ApiResponse<V1ClusterRoleList>> {
  const queryParameters: HTTPQuery = {}
  if (requestParameters.pretty !== undefined) {
    queryParameters['pretty'] = requestParameters.pretty
  }
...
export async function watchListClusterRoleBinding(
  ...
  callback: (event: KubeEvent<ItemType<V1ClusterRoleBindingList>>) => void,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<void> {
  const queryParameters: HTTPQuery = { watch: true }
  if (requestParameters.pretty !== undefined) {
  ...
  await requestStream<ItemType<V1ClusterRoleBindingList>>(
    callback,
    {
      path: `/apis/rbac.authorization.k8s.io/v1/clusterrolebindings`,
      method: 'GET',
...
export async function listClusterRoleBindingRaw(
  requestParameters: ListClusterRoleBindingRequest,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<ApiResponse<V1ClusterRoleBindingList>> {
  const queryParameters: HTTPQuery = {}
  if (requestParameters.pretty !== undefined) {
    queryParameters['pretty'] = requestParameters.pretty
  }
...
export async function listClusterRoleBinding(
  requestParameters: ListClusterRoleBindingRequest,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<V1ClusterRoleBindingList> {
...
export async function watchListNamespacedRole(
  ...
  callback: (event: KubeEvent<ItemType<V1RoleList>>) => void,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<void> {
  if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
    throw new Error(
  ...
  await requestStream<ItemType<V1RoleList>>(
    callback,
    {
      path: `/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/roles`.replace(
        `{${'namespace'}}`,
...
export async function listNamespacedRoleRaw(
  requestParameters: ListNamespacedRoleRequest,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<ApiResponse<V1RoleList>> {
  if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
    throw new Error(
      'Required parameter requestParameters.namespace was null or undefined when calling listNamespacedRole.'
    )
...
export async function watchListNamespacedRoleBinding(
  ...
  callback: (event: KubeEvent<ItemType<V1RoleBindingList>>) => void,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<void> {
  if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
    throw new Error(
  ...
  await requestStream<ItemType<V1RoleBindingList>>(
    callback,
    {
      path: `/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/rolebindings`.replace(
        `{${'namespace'}}`,
...
export async function listNamespacedRoleBindingRaw(
  requestParameters: ListNamespacedRoleBindingRequest,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<ApiResponse<V1RoleBindingList>> {
  if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
    throw new Error(
      'Required parameter requestParameters.namespace was null or undefined when calling listNamespacedRoleBinding.'
    )
