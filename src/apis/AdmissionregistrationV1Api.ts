...
): Promise<ApiResponse<V1MutatingWebhookConfiguration>> {
...
export async function createValidatingWebhookConfigurationRaw(
  ...
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<ApiResponse<V1ValidatingWebhookConfiguration>> {
  if (requestParameters.body === null || requestParameters.body === undefined) {
    throw new Error(
...
export async function watchListMutatingWebhookConfiguration(
  ...
  callback: (event: KubeEvent<ItemType<V1MutatingWebhookConfigurationList>>) => void,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<void> {
  ...
  await requestStream<ItemType<V1MutatingWebhookConfigurationList>>(
    callback,
    {
      path: `/apis/admissionregistration.k8s.io/v1/mutatingwebhookconfigurations`,
      method: 'GET',
...
export async function listMutatingWebhookConfigurationRaw(
  requestParameters: ListMutatingWebhookConfigurationRequest,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<ApiResponse<V1MutatingWebhookConfigurationList>> {
  const queryParameters: HTTPQuery = {}
  if (requestParameters.pretty !== undefined) {
    queryParameters['pretty'] = requestParameters.pretty
  }
...
export async function listMutatingWebhookConfiguration(
  requestParameters: ListMutatingWebhookConfigurationRequest,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<V1MutatingWebhookConfigurationList> {
...
export async function watchListValidatingWebhookConfiguration(
  ...
  callback: (event: KubeEvent<ItemType<V1ValidatingWebhookConfigurationList>>) => void,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<void> {
  const queryParameters: HTTPQuery = { watch: true }
  if (requestParameters.pretty !== undefined) {
  ...
  await requestStream<ItemType<V1ValidatingWebhookConfigurationList>>(
    callback,
    {
      path: `/apis/admissionregistration.k8s.io/v1/validatingwebhookconfigurations`,
      method: 'GET',
...
export async function listValidatingWebhookConfigurationRaw(
  requestParameters: ListValidatingWebhookConfigurationRequest,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<ApiResponse<V1ValidatingWebhookConfigurationList>> {
  const queryParameters: HTTPQuery = {}
  if (requestParameters.pretty !== undefined) {
    queryParameters['pretty'] = requestParameters.pretty
  }
...
export async function listValidatingWebhookConfiguration(
  requestParameters: ListValidatingWebhookConfigurationRequest,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<V1ValidatingWebhookConfigurationList> {
