...
import V1beta1APIService from '../models/V1beta1APIService'
import V1beta1APIServiceList from '../models/V1beta1APIServiceList'
...
): Promise<ApiResponse<V1beta1APIService>> {
...
export async function deleteAPIServiceRaw(
  ...
  const response = await request(
    {
      path: `/apis/apiregistration.k8s.io/v1beta1/apiservices/{name}`.replace(
        `{${'name'}}`,
...
export async function watchListAPIService(
  ...
  callback: (event: KubeEvent<ItemType<V1beta1APIServiceList>>) => void,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<void> {
  ...
  await requestStream<ItemType<V1beta1APIServiceList>>(
    callback,
    {
      path: `/apis/apiregistration.k8s.io/v1beta1/apiservices`,
      method: 'GET',
...
export async function listAPIServiceRaw(
  requestParameters: ListAPIServiceRequest,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<ApiResponse<V1beta1APIServiceList>> {
  const queryParameters: HTTPQuery = {}
  if (requestParameters.pretty !== undefined) {
    queryParameters['pretty'] = requestParameters.pretty
  }
...
export async function patchAPIServiceStatusRaw(
  ...
  const response = await request(
    {
      path: `/apis/apiregistration.k8s.io/v1beta1/apiservices/{name}/status`.replace(
        `{${'name'}}`,
        encodeURIComponent(String(requestParameters.name))
      ),
      method: 'PATCH',
