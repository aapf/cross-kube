...
): Promise<ApiResponse<V1beta1PriorityClass>> {
...
export async function watchListPriorityClass(
  ...
  callback: (event: KubeEvent<ItemType<V1beta1PriorityClassList>>) => void,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<void> {
  ...
  await requestStream<ItemType<V1beta1PriorityClassList>>(
    callback,
    {
      path: `/apis/scheduling.k8s.io/v1beta1/priorityclasses`,
      method: 'GET',
...
export async function listPriorityClassRaw(
  requestParameters: ListPriorityClassRequest,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<ApiResponse<V1beta1PriorityClassList>> {
  const queryParameters: HTTPQuery = {}
  if (requestParameters.pretty !== undefined) {
    queryParameters['pretty'] = requestParameters.pretty
  }
