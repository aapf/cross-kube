...
interface PatchCertificateSigningRequestApprovalRequest {
  name: string
...
interface ReadCertificateSigningRequestApprovalRequest {
  name: string
...
): Promise<ApiResponse<V1CertificateSigningRequest>> {
...
export async function createCertificateSigningRequest(
  requestParameters: CreateCertificateSigningRequestRequest,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<V1CertificateSigningRequest> {
...
export async function watchListCertificateSigningRequest(
  ...
  callback: (event: KubeEvent<ItemType<V1CertificateSigningRequestList>>) => void,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<void> {
  ...
  await requestStream<ItemType<V1CertificateSigningRequestList>>(
    callback,
    {
      path: `/apis/certificates.k8s.io/v1/certificatesigningrequests`,
      method: 'GET',
...
export async function listCertificateSigningRequestRaw(
  requestParameters: ListCertificateSigningRequestRequest,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<ApiResponse<V1CertificateSigningRequestList>> {
  const queryParameters: HTTPQuery = {}
  if (requestParameters.pretty !== undefined) {
    queryParameters['pretty'] = requestParameters.pretty
  }
...
export async function listCertificateSigningRequest(
  requestParameters: ListCertificateSigningRequestRequest,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<V1CertificateSigningRequestList> {
 ...
 */
export async function patchCertificateSigningRequestApprovalRaw(
  requestParameters: PatchCertificateSigningRequestApprovalRequest,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<ApiResponse<V1CertificateSigningRequest>> {
  if (requestParameters.name === null || requestParameters.name === undefined) {
    throw new Error(
      'Required parameter requestParameters.name was null or undefined when calling patchCertificateSigningRequestApproval.'
    )
  }
  if (requestParameters.body === null || requestParameters.body === undefined) {
    throw new Error(
      'Required parameter requestParameters.body was null or undefined when calling patchCertificateSigningRequestApproval.'
    )
  }
  const queryParameters: HTTPQuery = {}
  if (requestParameters.pretty !== undefined) {
 ...
 * partially update approval of the specified CertificateSigningRequest
 */
export async function patchCertificateSigningRequestApproval(
  requestParameters: PatchCertificateSigningRequestApprovalRequest,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<V1CertificateSigningRequest> {
  const response = await patchCertificateSigningRequestApprovalRaw(
    requestParameters,
    ...requestOptsArray
  )
  return await response.value()
 ...
 */
export async function readCertificateSigningRequestApprovalRaw(
  requestParameters: ReadCertificateSigningRequestApprovalRequest,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<ApiResponse<V1CertificateSigningRequest>> {
  if (requestParameters.name === null || requestParameters.name === undefined) {
    throw new Error(
      'Required parameter requestParameters.name was null or undefined when calling readCertificateSigningRequestApproval.'
    )
  }
  const queryParameters: HTTPQuery = {}
  if (requestParameters.pretty !== undefined) {
 ...
 * read approval of the specified CertificateSigningRequest
 */
export async function readCertificateSigningRequestApproval(
  requestParameters: ReadCertificateSigningRequestApprovalRequest,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<V1CertificateSigningRequest> {
  const response = await readCertificateSigningRequestApprovalRaw(
    requestParameters,
    ...requestOptsArray
  )
  return await response.value()
