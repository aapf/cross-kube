...
): Promise<ApiResponse<V1IngressClass>> {
...
export async function watchListIngressClass(
  ...
  callback: (event: KubeEvent<ItemType<V1IngressClassList>>) => void,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<void> {
  ...
  await requestStream<ItemType<V1IngressClassList>>(
    callback,
    {
      path: `/apis/networking.k8s.io/v1/ingressclasses`,
      method: 'GET',
...
export async function listIngressClassRaw(
  requestParameters: ListIngressClassRequest,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<ApiResponse<V1IngressClassList>> {
  const queryParameters: HTTPQuery = {}
  if (requestParameters.pretty !== undefined) {
    queryParameters['pretty'] = requestParameters.pretty
  }
...
export async function watchListIngressForAllNamespaces(
  ...
  callback: (event: KubeEvent<ItemType<V1IngressList>>) => void,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<void> {
  const queryParameters: HTTPQuery = { watch: true }
  if (requestParameters.allowWatchBookmarks !== undefined) {
  ...
  await requestStream<ItemType<V1IngressList>>(
    callback,
    {
...
export async function listIngressForAllNamespacesRaw(
  requestParameters: ListIngressForAllNamespacesRequest,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<ApiResponse<V1IngressList>> {
  const queryParameters: HTTPQuery = {}
  if (requestParameters.allowWatchBookmarks !== undefined) {
    queryParameters['allowWatchBookmarks'] = requestParameters.allowWatchBookmarks
  }
