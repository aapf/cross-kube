...
): Promise<ApiResponse<V1CSIDriver>> {
...
export async function watchListCSIDriver(
  ...
  callback: (event: KubeEvent<ItemType<V1CSIDriverList>>) => void,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<void> {
  ...
  await requestStream<ItemType<V1CSIDriverList>>(
    callback,
    {
      path: `/apis/storage.k8s.io/v1/csidrivers`,
      method: 'GET',
...
export async function listCSIDriverRaw(
  requestParameters: ListCSIDriverRequest,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<ApiResponse<V1CSIDriverList>> {
  const queryParameters: HTTPQuery = {}
  if (requestParameters.pretty !== undefined) {
    queryParameters['pretty'] = requestParameters.pretty
  }
...
export async function watchListCSINode(
  ...
  callback: (event: KubeEvent<ItemType<V1CSINodeList>>) => void,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<void> {
  const queryParameters: HTTPQuery = { watch: true }
  if (requestParameters.pretty !== undefined) {
  ...
  await requestStream<ItemType<V1CSINodeList>>(
    callback,
    {
      path: `/apis/storage.k8s.io/v1/csinodes`,
      method: 'GET',
...
export async function listCSINodeRaw(
  requestParameters: ListCSINodeRequest,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<ApiResponse<V1CSINodeList>> {
  const queryParameters: HTTPQuery = {}
  if (requestParameters.pretty !== undefined) {
    queryParameters['pretty'] = requestParameters.pretty
  }
