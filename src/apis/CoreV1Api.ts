...
import V1TokenRequest from '../models/V1TokenRequest'
...
interface CreateNamespacedServiceAccountTokenRequest {
  name: string
...
export async function createNamespacedEventRaw(
  ...
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<ApiResponse<CoreV1Event>> {
  if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
    throw new Error(
 ...
 */
export async function createNamespacedServiceAccountTokenRaw(
  requestParameters: CreateNamespacedServiceAccountTokenRequest,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<ApiResponse<V1TokenRequest>> {
  if (requestParameters.name === null || requestParameters.name === undefined) {
    throw new Error(
      'Required parameter requestParameters.name was null or undefined when calling createNamespacedServiceAccountToken.'
    )
  }
  if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
    throw new Error(
      'Required parameter requestParameters.namespace was null or undefined when calling createNamespacedServiceAccountToken.'
    )
  }
  if (requestParameters.body === null || requestParameters.body === undefined) {
    throw new Error(
      'Required parameter requestParameters.body was null or undefined when calling createNamespacedServiceAccountToken.'
    )
  }
  const queryParameters: HTTPQuery = {}
  if (requestParameters.dryRun !== undefined) {
 ...
 * create token of a ServiceAccount
 */
export async function createNamespacedServiceAccountToken(
  requestParameters: CreateNamespacedServiceAccountTokenRequest,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<V1TokenRequest> {
  const response = await createNamespacedServiceAccountTokenRaw(
    requestParameters,
    ...requestOptsArray
  )
  return await response.value()
...
export async function watchListEventForAllNamespaces(
  ...
  callback: (event: KubeEvent<ItemType<CoreV1EventList>>) => void,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<void> {
  const queryParameters: HTTPQuery = { watch: true }
  if (requestParameters.allowWatchBookmarks !== undefined) {
  ...
  await requestStream<ItemType<CoreV1EventList>>(
    callback,
    {
      path: `/api/v1/events`,
      method: 'GET',
...
export async function listEventForAllNamespacesRaw(
  requestParameters: ListEventForAllNamespacesRequest,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<ApiResponse<CoreV1EventList>> {
  const queryParameters: HTTPQuery = {}
  if (requestParameters.allowWatchBookmarks !== undefined) {
    queryParameters['allowWatchBookmarks'] = requestParameters.allowWatchBookmarks
  }
