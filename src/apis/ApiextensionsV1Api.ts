...
): Promise<ApiResponse<V1CustomResourceDefinition>> {
...
export async function watchListCustomResourceDefinition(
  ...
  callback: (event: KubeEvent<ItemType<V1CustomResourceDefinitionList>>) => void,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<void> {
  ...
  await requestStream<ItemType<V1CustomResourceDefinitionList>>(
    callback,
    {
      path: `/apis/apiextensions.k8s.io/v1/customresourcedefinitions`,
      method: 'GET',
...
export async function listCustomResourceDefinitionRaw(
  requestParameters: ListCustomResourceDefinitionRequest,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<ApiResponse<V1CustomResourceDefinitionList>> {
  const queryParameters: HTTPQuery = {}
  if (requestParameters.pretty !== undefined) {
    queryParameters['pretty'] = requestParameters.pretty
  }
...
export async function listCustomResourceDefinition(
  requestParameters: ListCustomResourceDefinitionRequest,
  ...requestOptsArray: Partial<RequestOpts>[]
): Promise<V1CustomResourceDefinitionList> {
