 ...
 * @export
 * @interface V1CertificateSigningRequestStatus
 */
export default interface V1CertificateSigningRequestStatus extends KubeObject {
  /**
   ...
   * @type {string}
   * @memberof V1CertificateSigningRequestStatus
   */
  certificate?: string
